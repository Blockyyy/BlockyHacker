...
const LevelScript level_castle_inside_entry[] = {
	...
	AREA(1, castle_inside_area_1),
		...
		OBJECT(MODEL_CASTLE_STAR_DOOR_8_STARS, -64, -486, 1691, 0, 0, 0, (8 << 16), bhvStarDoor),
		OBJECT(MODEL_CASTLE_STAR_DOOR_8_STARS, 84, -486, 1689, 0, -180, 0, (8 << 16), bhvStarDoor),
		OBJECT(MODEL_CASTLE_CASTLE_DOOR, -70, 512, -1990, 0, 0, 0, (8 << 16), bhvDoorWarp),
		OBJECT(MODEL_CASTLE_CASTLE_DOOR, 84, 512, -1990, 0, -180, 0, (8 << 16), bhvDoorWarp),
		...
		OBJECT(MODEL_TOAD, 498, 512, -1288, 0, 151, 0, 0x00000000, bhvToadMessage),
