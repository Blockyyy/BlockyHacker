...
struct DynList dynlist_mario_eye_right_shape[] = {
    ...
    StartGroup(DYNOBJ_MARIO_RIGHT_EYE_MTL_GROUP),
        ...
        SetId(0),
        SetAmbient(1.0, 0.0, 0.0018377654487267137),
        SetDiffuse(1.0, 0.0, 0.0018377654487267137),
        MakeDynObj(D_MATERIAL, 0x0),
        SetId(1),
        SetAmbient(1.0, 0.001273894333280623, 0.0),
        SetDiffuse(1.0, 0.001273894333280623, 0.0),
        MakeDynObj(D_MATERIAL, 0x0),
        SetId(2),
